...
public class BookDaoJdbc implements BookDao {
    ...
    private static final String FIND_BY_BOOK_ID_SQL =
            "SELECT book_id, title, author, description, price, is_public, category_id " +
                    "FROM book " +
                    "WHERE book_id = ?";
    ...
    public List<Book> findByCategoryId(long categoryId) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Error fetching books for category ID: " + categoryId, e);
        }
        return books;
    }
@Override
public List<Book> findRandomByCategoryId(long categoryId, int limit) {
    ...
    private Book readBook(ResultSet resultSet) throws SQLException {
        ...
        return new Book(bookId, title, author, description, price, isPublic, categoryId);
    }
